...
SELECT  BOOK_NO,WRITER_NO,ISSUE_DATE FROM TB_BOOK_AUTHOR
JOIN TB_BOOK USING (BOOK_NO)
GROUP BY WRITER_NO,BOOK_NO,ISSUE_DATE;
...
UPDATE TB_WRITER
SET REGIST_DATE = SELECT  BOOK_NO,WRITER_NO,ISSUE_DATE FROM TB_BOOK_AUTHOR
JOIN TB_BOOK USING (BOOK_NO)
GROUP BY WRITER_NO,BOOK_NO,ISSUE_DATE)
(SELECT  BOOK_NO,WRITER_NO,ISSUE_DATE FROM TB_BOOK_AUTHOR
JOIN TB_BOOK USING (BOOK_NO)
...
SELECT BOOK_NO,작가명,작가번호 
FROM(SELECT DISTINCT(WRITER_NM) AS "작가명",WRITER_NO "작가번호" FROM TB_WRITER)
